...
智能家居控制中心，可以把不同品牌的智能家居接到一起，举几个例子：

- 用 Siri 关米家的灯
- 美的洗碗机清洗结束用小爱音箱提醒通知
- 任意摄像头人脸识别后自动打开门锁（需要 frigate）

**我的评价是可玩性高，自定义强，但非常折腾，一旦折腾好了比米家强太多**，几乎所有能联网的设备都能玩。[米家官方插件](https://github.com/XiaoMi/ha_xiaomi_home)正在频繁更新，~~期待它成熟的那一天~~直接换能接入 HA 的设备。

### Frigate

强大的监控平台，支持数百种物体检测、音频检测，支持本地人脸识别。可以接入 Home Assistant 实时查看和手机通知。

我目前室内的摄像头会重点检测小孩哭声并给手机发送通知，门口的摄像头有人就会立即通知手机。实测通知比事件的发生时间只慢了不到3秒，非常快。

我用 i3-12100T 的核显应付双路 4K 20 帧的视频流绰绰有余，平均 GPU 占用不到 10%，CPU占用更是 3% 都不到，甚至看不出功耗的增加。

只要能推流的摄像头都可以，推荐 onvif、rtsp 协议，米家的摄像头不行，太封闭了，也许后面小米NAS发布的时候会开放视频流吧，反正我是不等了，家用摄像头这么便宜直接换掉。
